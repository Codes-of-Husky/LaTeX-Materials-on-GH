...
\vspace*{0.5cm}
\begin{center}
{\Large \bf Class Report \\[1ex] OF UCAS }
\end{center}
\vspace{2.5cm}
...
\begin{center}
   \ifprint % 文档打印, 使用黑白校徽.
  \includegraphics[height=2cm]{UCASLogoLevel.png}       %%  黑白的.
  \else
  \includegraphics[height=2cm]{UCASLogoLevel.png} %%  彩色的.
  \fi
\end{center}
...
\zihao{-2}
%\the\Schoolname\\
{\sc University of Chinese Academy of Sciences}
